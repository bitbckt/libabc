 ...
 **/
ABC_EXPORT void *
abc_get_userdata(struct abc_ctx *ctx)
{
     if (ctx == NULL) {
          return NULL;
     }
 ...
 **/
ABC_EXPORT void
abc_set_userdata(struct abc_ctx *ctx, void *userdata)
{
     if (ctx == NULL) {
          return;
     }
 ...
 **/
ABC_EXPORT struct abc_ctx *
abc_ref(struct abc_ctx *ctx)
{
     if (ctx == NULL) {
          return NULL;
     }
 ...
 **/
ABC_EXPORT void
abc_set_log_fn(struct abc_ctx *ctx,
               void (*log_fn)(struct abc_ctx *ctx,
 ...
 **/
ABC_EXPORT int
abc_get_log_priority(struct abc_ctx *ctx)
{
 ...
 **/
ABC_EXPORT void
abc_set_log_priority(struct abc_ctx *ctx, int priority)
{
...
ABC_EXPORT struct abc_thing *
abc_thing_ref(struct abc_thing *thing)
{
     if (!thing) {
          return NULL;
     }
...
ABC_EXPORT struct abc_thing *
abc_thing_unref(struct abc_thing *thing)
{
     if (thing == NULL) {
          return NULL;
     }
...
ABC_EXPORT struct abc_ctx *
abc_thing_get_ctx(struct abc_thing *thing)
{
     return thing->ctx;
}
